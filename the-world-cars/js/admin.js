/* ==========================================================================
   THE WORLD CARS - Admin Suite (v2.3)
   Includes: Drag-and-Drop Image Uploader, Services CRUD & Logo Customizer
   ========================================================================== */
...
function initDropzoneUploaders() {
  document.querySelectorAll('.dropzone').forEach(dropzone => {
    ...
    const previewImg = dropzone.parentElement.querySelector('.dropzone-preview');
    const targetUrlInput = dropzone.parentElement.querySelector('input[name="image"]');
...
function handleFileSelect(file, previewImg, targetUrlInput) {
  ...
  reader.onload = (evt) => {
    ...
    if (targetUrlInput) targetUrlInput.value = base64Data;
    if (previewImg) {
...
// Render Services Management Tables (Officina & Soccorso Stradale)
function renderAdminServicesTables() {
  // Officina Services Table
  ...
  // Assistenza Stradale Services Table
...
// Admin Settings & Logo Form Loader
