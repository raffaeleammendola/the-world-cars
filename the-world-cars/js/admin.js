/* ==========================================================================
   THE WORLD CARS - Professional Admin Panel & Authentication Controller
   ========================================================================== */
...
// Open Admin Modal & Check Active Session
...
// Render Requests Table with Filter Search
let adminSearchTerm = '';
...
window.handleSettingsSubmit = async function(e) {
  ...
  const newPassword = formData.get('newAdminPassword');
  ...
  if (newPassword && newPassword.trim() !== '') {
    updatedConfig.newPassword = newPassword.trim();
  }
