/* ==========================================================================
   THE WORLD CARS - Central Production Store & Relational Cloud Sync Engine (v2.5)
   Features: Dual Email Dispatcher (Owner + Client), Multi-Channel Confirmations
   ========================================================================== */
...
class AppStore {
  ...
  // --- Email Notification Dispatcher to Owner & Client ---
