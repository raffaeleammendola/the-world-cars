/* ==========================================================================
   THE WORLD CARS - Central Production Store & Relational Cloud Sync Engine (v2.3)
   Features: Services CRUD (Officina & Soccorso), Dynamic Email Recipient & Logo Binding
   ========================================================================== */
...
class AppStore {
  ...
  async createRequest(reqData) {
    ...
    // Trigger Notifications (Telegram & Dynamic Email)
