/* ==========================================================================
   THE WORLD CARS - Main UI Engine (v2.4)
   Features: Multi-Channel Emergency Dispatcher & Red Date Collision Lock
   ========================================================================== */
...
// Dynamic Site Configuration Binder
...
window.openCarModal = function(carId) {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    showToast("Prenotazione inviata con successo! (Telegram, Email e DB sincronizzati)");
...
window.requestEmergencyWhatsAppEnhanced = function(serviceName = 'Soccorso Generico Immediato') {
  ...
  // Trigger Multi-Channel Request to Telegram & Email to Gmail
  store.createRequest({
...
function initForms() {
  ...
  if (emergencyForm) {
    emergencyForm.addEventListener('submit', async (e) => {
      ...
      await store.createRequest(reqObj);
      showToast("Segnalazione urgente inviata! Notifiche Telegram e Gmail spedite.", "emergency");
